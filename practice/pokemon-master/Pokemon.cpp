...
void disp(int choice)	//1- how to play   2-About
{
	...
	Text howto[10];
	char str1[][95] = {"",
					  "- Select your avatar and Pok�mon.",
					  "- Free roam on the map using the arrow keys.",
					  "- Wander in the         areas to attempt to find wild Pok�mon to battle.",
					  ...
					  "- You can check out the Pok�dex to learn more about the Pok�mon",
...
void pokedex()
{
	RenderWindow pokedex(VideoMode(1537, 827), "Pok�dex", Style::None);
...
{
	RenderWindow pokeinf(VideoMode(1537, 827), "Pok�dex Info", Style::None);
...
void choosepoke()
{
	...
	RenderWindow choosewin(VideoMode(1537, 827), "Pok�mon Select", Style::None);
	choosewin.setPosition(sf::Vector2i(0, 0));	
	...
	//"Choose" text
	Text choose("Choose your Pok�mon", font1, 80);
	choose.setColor(sf::Color::White);
